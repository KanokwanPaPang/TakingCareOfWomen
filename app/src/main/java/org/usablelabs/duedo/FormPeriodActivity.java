...
public class FormPeriodActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_period);
        setDrawer(true);
    ...
    public void onStart(){
        ...
        EditText date2Edit=(EditText)findViewById(R.id.date2Edit);
        date2Edit.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    DateDialog dialog=new DateDialog(v);
